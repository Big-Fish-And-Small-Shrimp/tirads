...
class ResNet(nn.Module):
    ...
    def residual_block(self, residual, channel, num_residuals, stride=1):
        ...
        self.out_channel = channel * residual.expansion  # Output channel out_channel expansion
...
def train(net, train_iter, num_epochs, lr, device):
    ...
    torch.save(min_loss_state_dict, 'ResNet34.pth')
...
with torch.no_grad():
    for k in range(len(a)):
        ...
        if k == 0:
            ...
            plt.savefig(f"ResNet34_ROC曲线图.png")